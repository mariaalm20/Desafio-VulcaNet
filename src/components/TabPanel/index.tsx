...
const TabPanel: React.FC<TypePlan> = ({ isMonth }) => {
    ...
    <Container>
        ...
        {plans.map((plan) => (
          <InfoPlans key={plan.id}>
            ...
            <ButtonSelect
              ...
              className={
                plan.id === 2 &&
                selectTypePlan !== "Plano 1.0" &&
                selectTypePlan !== "Plano Turbo"
                  ? "active"
                  : plan.id === 1 &&
                    selectTypePlan !== "Plano 2.0" &&
                    selectTypePlan !== "Plano Turbo"
                  ? "active"
                  : plan.id === 3 &&
                    selectTypePlan !== "Plano 1.0" &&
      ...
      <Footer>
        <ColumnFooter>
          {isMonth ? (
            <>
              <Total>Total: R${selectPlanMonth}/mês</Total>
              <SelectPlan>
            ...
            <>
              <Total>Total: R${selectPlanYear}/mês</Total>
              <SelectPlan>
